...
public class Stu_Ex4 {
	...
	public static void main(String[] args) {
		 ...
		 *   <2차원 배열 크기>
		 *   1. 행의 크기 : 변수명.length
		 *   2. 열의 크기 : 변수명[행번호].length(행번호마다 열의 크기가 달라질 수 있음)
		 *   
...
//		arr = new int[3][2];
		...
		//2. 벼열의 각 행에 대한 열 크기 알아내기 : 배열명[행인덱스].length
		...
		System.out.println("-----------------------------------------------");
		int[][] arr2 = {
				//전체 블록 내의 중괄호(블록) 갸수 = 행의 개수
				//내부 중괄호(블록) 내으 ㅣ데이터 개수 = 열의 개수
				{1,2}, //0행
				{3,4}, //1행
				{5,6}, //2행
		};
