...
public class Test2 {
	...
	public static void main(String[] args) {
		...
		String[] passwords = {"Abcde123!", "abcde123@", "abcde123", 
											"12345678", "abcde한글!"};
...
//			String password = s.nextLine();
			...
			if(Pattern.matches(lengthRegex, password)) {
				...
				// 검사할 정규표현식으로 Pattern 객체 생성 및 Pattern 객체로 Matcher객체 생성
...
//				}
				...
				// => 주의! 각 정규표힌식 판별 문장을 else if로 처리하면 안된다!
