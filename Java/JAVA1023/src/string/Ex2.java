...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"s1.equals(JAVA PROGRAMMING) : " + s1.equals("JAVA PROGRAMMING"));
		
		// equalsIgnoreCase() : 문자열 비교(대소문자 구별하지 않고 비교)
		System.out.println("s1.equalsIngoreCase(JAVA PROGRAMMING) : " 
...
//		String[] strArr = s4.split("."); // 모든 문자열이 제거되므로 사용 불가
		...
		String s5 = "admin123!";
		char[] chArr = s5.toCharArray(); // a, d, m, i, n, 1, 2, 3, ! 로 분리되어 저장
