...
public class ChatService {
	...
	public void addChatRoom(ChatMessage2 chatMessage) {
		...
		chatRoom.add(new ChatRoomVO(chatMessage.getRoom_id(), chatMessage.getSender_id(), "채팅-" + chatMessage.getReceiver_id(), null));
		chatRoom.add(new ChatRoomVO(chatMessage.getRoom_id(), chatMessage.getReceiver_id(), "채팅-" + chatMessage.getSender_id(), null));
