...
public class Ex6 {
	...
	public static void main(String[] args) {
		 ...
		 * - 피연산자 모두 boolean 타입 데이터(true, false)
		 ...
		 *   => 주로 A 조건 도는 B 조건 중 하나라도 만족하는 조건을 판별할 떄 사용
		...
		System.out.println("a(false) && a(flase) = " + (a && a));
		System.out.println("a(false) && b(true)  = " + (a && b));
		System.out.println("b(true)  && a(flase) = " + (b && a));
		...
		// => ~이고, 그리고 등의 의미는 AND연산자 && 사용하여 결합 dddd
